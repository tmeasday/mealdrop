...
- Create stories for new/updated components as soon as the component implementation is ready, even if the stories will be incomplete at first. This provides a live visual reference during development and allows the story interaction tests to be written in parallel.
